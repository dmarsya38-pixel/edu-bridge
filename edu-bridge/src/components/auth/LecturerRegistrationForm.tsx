        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              onChange={handleInputChange}
              onBlur={handleBlur}
              className="w-full border border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 pr-10 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
            <button
              type="button"
