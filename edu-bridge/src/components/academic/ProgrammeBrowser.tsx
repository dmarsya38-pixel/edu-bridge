...
export function ProgrammeBrowser({ 
            ...
            <button
              ...
              className={`p-3 rounded-xl border-2 text-left transition-colors ${
                currentProgramme === programme.programmeCode
                  ? 'border-blue-1000 bg-blue-50 dark:bg-blue-900/20 text-blue-900 dark:text-blue-100'
  ...
  <div 
    key={semester}
    className={`pb-6 ${semester !== SEMESTERS[SEMESTERS.length - 1] ? 'border-b border-gray-300 dark:border-gray-700 mb-6' : ''}`}
  >
        ...
        <button
          ...
          className={`p-3 rounded-lg border text-left transition-colors hover:bg-gray-50 dark:hover:bg-gray-700 ${
            selectedSubjectCode === subject.subjectCode
              ? 'border-blue-1000 bg-blue-50 dark:bg-blue-900/20'
